 ...
 */
template <class OutputIterator>
OutputIterator BV::intersect_BV_trees(BVPtr a, BVPtr b, const std::pair<Ravelin::Quatd, Ravelin::Origin3d>& aTb, const std::pair<Ravelin::Quatd, Ravelin::Origin3d>& bTa, OutputIterator output_begin)
{
  ...
  while (!q.empty())
  {
    ...
    const std::pair<Ravelin::Quatd, Ravelin::Origin3d>& iT = (!reversed) ? aTb : bTa;
    q.pop();
