...
class CompGeom
{
  ...
  public:
    ...
    static SegTriIntersectType intersect_seg_tri(const LineSeg3& seg, const Triangle& t, Ravelin::Point3d& isect, Ravelin::Point3d& isect2, double tol = NEAR_ZERO);
    static SegTriIntersectType intersect_seg_tri(const LineSeg2& seg, const Ravelin::Point2d tri[3], Ravelin::Point2d& isect, Ravelin::Point2d& isect2, double tol = NEAR_ZERO);
    static SegSegIntersectType intersect_segs(const LineSeg3& s1, const LineSeg3& s2, Ravelin::Point3d& isect, Ravelin::Point3d& isect2);
    static double intersect_seg_plane(const Ravelin::Vector3d& nrm, double d, const LineSeg3& seg);
    static SegPlaneIntersectType intersect_seg_plane(const Triangle& tri, const LineSeg3& seg, Ravelin::Point3d& isect, unsigned int& big_dim, double tol = NEAR_ZERO);
    static SegSegIntersectType intersect_segs(const LineSeg2& s1, const LineSeg2& s2, Ravelin::Point2d& isect, Ravelin::Point2d& isect2);
    static LineLineIntersectType intersect_lines(const Ravelin::Point2d& o1, const Ravelin::Vector2d& dir1, double min1, double max1, const Ravelin::Point2d& o2, const Ravelin::Vector2d& dir2, double min2, double max2, double& s, double& t);
    static bool collinear(const Ravelin::Point3d& a, const Ravelin::Point3d& b, const Ravelin::Point3d& c, double tol = NEAR_ZERO);
    static PolygonLocationType in_tri(const Ravelin::Point2d t[3], const Ravelin::Point2d& p, double tol = NEAR_ZERO);
    static bool collinear(const Ravelin::Point2d& a, const Ravelin::Point2d& b, const Ravelin::Point2d& c, double tol = NEAR_ZERO);
    ...
    static double calc_closest_points(const LineSeg3& s1, const LineSeg3& s2, Ravelin::Point3d& p1, Ravelin::Point3d& p2); 
    static bool query_intersect_tri_tri(const Triangle& t1, const Triangle& t2);
    static PolygonLocationType in_tri(const Triangle& t, const Ravelin::Point3d& p, double tol = NEAR_ZERO);
    ...
    static OutputIterator intersect_seg_tri(const LineSeg2& seg, const Ravelin::Point2d tri[3], OutputIterator output_begin);

    template <class OutputIterator>
    static OutputIterator intersect_segs(const LineSeg2& s1, const LineSeg2& s2, OutputIterator output_begin);

     template <class OutputIterator>
     static OutputIterator intersect_tris(const Ravelin::Point2d t1[3], const Ravelin::Point2d t2[3], OutputIterator output_begin);
  ...
  private:
    ...
    static void update_box(const Ravelin::Point2d& lP, const Ravelin::Point2d& rP, const Ravelin::Point2d& bP, const Ravelin::Point2d& tP, const Ravelin::Vector2d& U, const Ravelin::Vector2d& V, double& min_area_div4, Ravelin::Point2d& center, Ravelin::Vector2d axis[2], double extent[2]);
    ...
    static bool intersect(const Ravelin::Point2d& a, const Ravelin::Point2d& b, const Ravelin::Point2d& c, const Ravelin::Point2d& d, double tol = NEAR_ZERO);
    static bool intersect_prop(const Ravelin::Point2d& a, const Ravelin::Point2d& b, const Ravelin::Point2d& c, const Ravelin::Point2d& d, double tol = NEAR_ZERO);
    static void clip_convex_polygon_against_line(const Ravelin::Vector2d& rkN, double fC, unsigned& riQuantity, Ravelin::Point2d akV[6]);
    ...
    template <class OutputIterator>
    static unsigned advance(unsigned a, unsigned* aa, unsigned n, bool inside, const Ravelin::Point2d& p, OutputIterator& current);

    static bool same_side(const Ravelin::Point3d& p1, const Ravelin::Point3d& p2, const Ravelin::Point3d& a, const Ravelin::Point3d& b, double tol = std::sqrt(std::numeric_limits<double>::epsilon()));
    static bool compute_intervals_isectline(const Triangle& t1, double vv0, double vv1, double vv2, double d0, double d1, double d2, double d0d1, double d0d2, double& isect0, double& isect1, Ravelin::Point3d& isectpoint0, Ravelin::Point3d& isectpoint1);
    static void isect2X(const Ravelin::Point3d& vtx0, const Ravelin::Point3d& vtx1, const Ravelin::Point3d& vtx2, double vv0, double vv1, double vv2, double d0, double d1, double d2, double& isect0, double& isect1, Ravelin::Point3d& isectpoint0, Ravelin::Point3d& isectpoint1);
    static SegSegIntersectType get_parallel_intersect_type(const LineSeg2& s1, const LineSeg2& s2, Ravelin::Point2d& isect, Ravelin::Point2d& isect2);
    static bool between(const Ravelin::Point2d& a, const Ravelin::Point2d& b, const Ravelin::Point2d& c, double tol = NEAR_ZERO);
    static SegTriIntersectType seg_tri_cross(const LineSeg3& seg, const Triangle& t, double tol = NEAR_ZERO);
    static SegTriIntersectType intersect_seg_tri_in_plane(const LineSeg3& seg, const Triangle& t, Ravelin::Point3d& isect, Ravelin::Point3d& isect2, double tol = NEAR_ZERO);
    static PolygonLocationType in_tri(const Triangle& t, const Ravelin::Point3d& p, unsigned int skip_dim, double tol = NEAR_ZERO);
    static void find_plane_coeff(const Triangle& t, Ravelin::Vector3d& N, unsigned int& m, double& dot);
    static Ravelin::Vector3d normal_vec(const Ravelin::Point3d& a, const Ravelin::Point3d& b, const Ravelin::Point3d& c);
    static OrientationType area_sign(const Ravelin::Point2d& a, const Ravelin::Point2d& b, const Ravelin::Point2d& c, double tol = NEAR_ZERO);
    static long double area(const Ravelin::Point2d& a, const Ravelin::Point2d& b, const Ravelin::Point2d& c);
    static bool test_edge_edge(const Ravelin::Point3d& p, const Ravelin::Point3d& a, const Ravelin::Point3d& b, double Ax, double Ay, unsigned i0, unsigned i1);
    static bool test_edge_tri(const Ravelin::Point3d& a, const Ravelin::Point3d& b, const Triangle& t, unsigned i0, unsigned i1);
    static bool test_point_in_tri(const Ravelin::Point3d& p, const Triangle& t, unsigned i0, unsigned i1);
...
template <class T>
class CompGeomSpecOne<T, Ravelin::Point3d>
{
...
template <class T>
class CompGeomSpecOne<T, Ravelin::Point2d>
{
  friend class CompGeom;
  ...
  private:
    ...
    static void calc_min_area_bounding_rect(T begin, T end, Ravelin::Point2d& p1, Ravelin::Point2d& p2, Ravelin::Point2d& p3, Ravelin::Point2d& p4); 
 ...
 */
template <class T, class U>
class CompGeomSpecTwo<T, U, Ravelin::Point2d*>
{
  friend class CompGeom;
 ...
 */
template <class T, class U>
class CompGeomSpecTwo<T, U, Ravelin::Point3d>
{
  friend class CompGeom;
