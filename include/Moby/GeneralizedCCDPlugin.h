...
class GeneralizedCCDPlugin
{
  public:
    ...
    virtual void get_vertices(BVPtr bv, std::vector<Ravelin::Point3d>& vertices) = 0; 
     ...
     *         <b>false</b> otherwise
     */
    virtual bool point_inside(BVPtr bv, const Ravelin::Point3d& p, Ravelin::Vector3d& normal) = 0;
     ...
     */
    virtual double intersect_seg(BVPtr bv, const LineSeg3& seg, Ravelin::Point3d& isect, Ravelin::Vector3d& normal) = 0;
