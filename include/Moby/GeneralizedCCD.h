...
class GeneralizedCCD : public CollisionDetection
{
  ...
  private:
    ...
    std::map<CollisionGeometryPtr, PosePair> get_poses(const std::vector<std::pair<ControlledBodyPtr, Ravelin::VectorNd> >& q0, const std::vector<std::pair<ControlledBodyPtr, Ravelin::VectorNd> >& q1);
