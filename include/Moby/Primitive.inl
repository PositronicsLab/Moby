 ...
 * \param output beginning iterator to a container of type Ravelin::Point3d; unique
 *        vertices are copied here on return
 * \return ending iterator to a container of type Ravelin::Point3d; unique vertices
 *         are copied here on return
 */
template <class InputIterator, class OutputIterator>
OutputIterator Primitive::get_vertices(const IndexedTriArray& tris, InputIterator fselect_begin, InputIterator fselect_end, OutputIterator output)
{
