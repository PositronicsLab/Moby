...
#ifndef _DEFORMABLE_CCD_H
#define _DEFORMABLE_CCD_H
...
/// An extension of the GeneralizedCCD collision detector to deformable bodies 
class DeformableCCD : public CollisionDetection
{
  public:
    DeformableCCD();
  ...
  private:
    ...
    void populate_dstruct(DStruct* ds, CollisionGeometryPtr gb, CollisionGeometryPtr gs, const Ravelin::Vector3d& bs_lvel, const Ravelin::Vector3d& bs_avel, const Ravelin::Vector3d& bb_lvel, const Ravelin::Vector3d& bb_avel, BVPtr s_BV) const;
    void calc_pdot(DStruct* ds, CollisionGeometryPtr gb, CollisionGeometryPtr gs, const Ravelin::Vector3d& bs_lvel, const Ravelin::Vector3d& bs_avel, const Ravelin::Vector3d& bb_lvel, const Ravelin::Vector3d& bb_avel) const;
    ...
    void build_bv_vector(const std::map<SingleBodyPtr, std::pair<Ravelin::Vector3d, Ravelin::Vector3d> >& vel_map, std::vector<std::pair<double, BoundsStruct> >& bounds);
    double get_max_speed(boost::shared_ptr<DeformableBody> db, double dt) const;
    std::map<SingleBodyPtr, std::pair<Ravelin::Vector3d, Ravelin::Vector3d> > get_velocities(const std::vector<std::pair<DynamicBodyPtr, Ravelin::VectorNd> >& q0, const std::vector<std::pair<DynamicBodyPtr, Ravelin::VectorNd> >& q1, double dt) const;
